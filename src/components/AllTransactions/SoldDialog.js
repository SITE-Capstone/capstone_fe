    ...
    <div>
      ...
      >
        <DialogTitle className={classes.dialog} id="alert-dialog-slide-title">
          {"Sold " + buyingId.toUpperCase()}
        </DialogTitle>
        <DialogContent className={classes.dialog}>
          <DialogContentText id="alert-dialog-slide-description">
            <Typography variant="body1" className={classes.text}>
              {"Date sold: " + new Date(time).toLocaleString()}
            </Typography>
            <Typography variant="body1" className={classes.text}>
              {"Total amount sold: " + parseFloat(amount).toFixed(2)}
            </Typography>
            <Typography variant="body1" className={classes.text}>
              {"Price per " + buyingId.toUpperCase() + ": $" + parseFloat(totalPrice / amount).toFixed(4)}
            </Typography>
